...
function ListColumns({ columns }) {
  ...
  const addNewColumn = async () => {
    ...
    // Dùng cloneDeep (deep copy) để không làm ảnh hướng đến tính bất biến của Redux (Immutability ), hoặc có thể dùng concat thay cho push khi dùng cú pháp spread
